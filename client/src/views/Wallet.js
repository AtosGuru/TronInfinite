        ...
        <table class="w-full text-xl  text-white font-mono text-center hover:shadow-2xl ">
          <thead class="text-xl bg-transparent text-white uppercase ">
            <tr>
              <th
                scope="col"
                class="py-3 px-6 grid item-center gap-2 text-center"
              >
                <p>Wallet Address</p>
              </th>
            ...
            {wallets.map((wallet, index) =>
              auth.user._id == wallet.user ? (
                <tr class=" border-b bg-transparent " key={index}>
                  <td class="py-4 px-6">{wallet.address}</td>
                  <td class="py-4 px-6">
                    <button
                      onClick={() => {
                        deleteWallet(wallet._id);
                      }}
                      class="text-white p-2 bg-blue-500 hover:bg-blue-700 font-mono rounded rounded-tl-lg rounded-br-lg"
                    >
                      Delete
                    </button>
                  </td>
