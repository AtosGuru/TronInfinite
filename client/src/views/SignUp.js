    ...
    <>
      <div className="mt-10 relative">
        <img
          ...
          className="rounded-full a-round m-auto w-48 h-48 sm:grid sm:grid-col-1"
        />
        <h1 className="text-white text-4xl text-center font-mono mt-2">
          <Text tid={'signup'} />
        </h1>
        <div className=" py-10">
          <div className="n-container">
            <form
              className="max-w-[500px] w-5/6 m-auto text-white text-base"
              onSubmit={onSubmit}
            >
              <div className="">
              ...
              <div className=" rounded-bl-3xl rounded-tr-3xl  inline-flex justify-center items-center gap-5 text-white text-base  bg-transparent border border-white  w-full hover:border-[#1b65a7] hover:text-2xl  rounded-lg  px-6 py-3.5 text-center mt-10">
                ...
                <button type={'submit'} className="w-100 " value="Register">
                  <Text tid={'register'} />{' '}
                </button>
              </div>
              <p className="text-white text-center mt-2">
                <Text tid={'alreadyAccount'} />
                <span className="text-[#1b65a7]">
                  {' '}
                  &nbsp;{' '}
                  <Link to="/login">
