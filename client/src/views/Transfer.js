  ...
  return (
    <>
      <div className="p-5 relative">
        <h1 className="text-white text-3xl text-left font-mono mt-10">
          <Text tid={'platformTransfer'} />
        </h1>
        ...
        <div className=" py-10">
          <div className="">
            <form
              onSubmit={onSubmit}
              className="max-w-[500px] w-5/6  text-white text-xl"
            >
              <div>
                <p className="font-mono text-xl">
                  <Text tid={'platformAccount'} />
                </p>
                <input
                  type={'text'}
                  name="account"
              ...
              {/* <p className="text-white text-center mt-5">Don't have a account? <span className="text-[#1b65a7]"><Link to="/signup"><strong className="font-mono text-2xl">Sign Up</strong></Link></span></p> */}
            </form>
          </div>
        </div>
      </div>
