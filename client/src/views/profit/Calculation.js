            ...
            <div className="max-w-[500px] w-5/6  text-white text-xl">
              ...
              <div className="grid grid-cols-2 gap-4 mt-5">
                <div className=" ">
                  <input
                    type="button"
                    className=" gap-5 text-white text-base  bg-transparent border border-white  w-full hover:border-[#1b65a7] hover:text-xl  rounded-lg  px-6 py-3.5 text-center"
                    name="N1"
                    value={'N1-1%'}
                    percent="1"
                    onClick={onChange}
              ...
              <div className="grid grid-cols-3 gap-5  mt-5 p-2">
                <label className="">
                  <Text tid={'profit'} />: {Math.floor(profit)} $
                </label>
              </div>
              <div className="inline-flex p-2">
                <label className="">
                  <Text tid={'total'} /> : {Math.floor(total)} $
                </label>
              </div>
              <div className="p-2">
                <label>
