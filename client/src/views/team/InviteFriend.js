    ...
    <>
      <div className="container grid grid-cols-1 gap-4 m-auto md:grid md:grid-cols-1 relative">
        ...
        <div className="max-w-sm bg-transparent rounded-lg border border-gray-200 shadow-md m-auto text-center">
          <h1 className="text-white text-center text-3xl p-2">
            <Text tid={'invitationqrcode'} />
          </h1>
          <a href="#">
          ...
          <div className="p-5">
            ...
            <div className="bg-transparent   rounded-2xl p-5">
              <p className="mb-3 font-normal text-white  text-xl font-mono">
                <Text tid={'invitationlink'} />
              </p>
            ...
            <button
              className="inline-flex items-center m-auto py-2 px-3 text-xl  text-white rounded  rounded-tl-lg hover:border hover:border-[#1b65a7]  rounded-br-lg hover:text-xl bg-transparent  border border-white "
              onClick={copyText}
            >
              <svg
