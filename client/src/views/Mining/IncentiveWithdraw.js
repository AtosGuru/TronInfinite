...
function IncentiveWithdraw({ sendNotification }) {
            ...
            >
              ...
              <ul className="list-disc p-5">
                <li className="text-white text-md text-left">
                  You will receive 3.5% bonus of points.
                </li>
...
export default connect(mapStateToProps, { sendNotification })(IncentiveWithdraw);
