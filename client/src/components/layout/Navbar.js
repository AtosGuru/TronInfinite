...
const Navbar = ({ auth, logout }) => {
      ...
      >
        <ul className="flex flex-col p-4 mt-4 bg-transparent rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  ">
          ...
          <Link to={'/login'}>
            <p
              href="#"
              className="rounded-full  border-white block py-2 pr-4 pl-3 text-white  rounded rounded-border md:bg-transparent md:hover:text-blue-700 md:p-0  font-mono"
            >
              SignIn
            </p>
          </Link>
  ...
  return (
    <>
      <nav className=" border-gray-200 px-2 sm:px-4 py-2.5 rounded  relative  ">
